 ...
 * @param {boolean} [params.remindToCancel] — highlights cancel intent for trial/temporary plans
...
export function buildReminderEmailHtml({
  ...
  dashboardUrl = "https://www.renwize.com/dashboard",
}) {
        ...
        <table role="presentation" width="100%" style="max-width:520px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(30,37,74,0.08);">
          ...
          <tr>
            <td style="padding:8px 28px 24px 28px;color:${BRAND_NAVY};font-size:16px;line-height:1.6;">
              ...
              ${
                remindToCancel
                  ? '<p style="margin:0 0 16px 0;"><strong>Reminder to cancel:</strong> If this is a free trial or temporary plan, remember to cancel before the renewal date so you do not get charged.</p>'
                  : ""
              }
